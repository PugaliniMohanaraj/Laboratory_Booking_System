...
<body>
    ...
    <div class="row text-center g-4 mb-4">
      <div class="col-md-4">
        <div class="card-box">
          ...
          <a href="register_lab.php" class="dashboard-link">Register Lab</a>
        </div>
      </div>
      <div class="col-md-4">
        <div class="card-box">
          <div class="card-icon"><i class="bi bi-calendar-check"></i></div>
          <a href="book_lab.php" class="dashboard-link">Book Lab</a>
        </div>
      </div>
      <div class="col-md-4">
        <div class="card-box">
          <div class="card-icon"><i class="bi bi-shield-check"></i></div>
          <a href="approve_booking.php" class="dashboard-link">Approve Booking</a>
        </div>
      </div>
      <div class="col-md-4">
        <div class="card-box">
      ...
      <div class="col-md-4">
        <div class="card-box">
          <div class="card-icon"><i class="bi bi-tools"><i class="bi bi-person"></i></i></div>
          <a href="log_equipment.php" class="dashboard-link">Lab Equipment Usage</a>
        </div>
      </div>
  ...
  <div class="card-box">
    ...
    <a href="process_equipment_request_stu.php" class="dashboard-link">Process Equipment Requests</a>
  </div>
</div>
 <div class="col-md-6">
        <div class="card-box">
