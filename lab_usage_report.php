...
<head>
  ...
  <title>Lab Usage Summary</title>

  <!-- Bootstrap CSS -->
  <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.3.0/dist/css/bootstrap.min.css" rel="stylesheet" />
      <link href="https://cdn.jsdelivr.net/npm/bootstrap-icons@1.10.5/font/bootstrap-icons.css" rel="stylesheet" />

   <link rel="stylesheet" href="css/lab_usage_report.css">
  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse justify-content-between" id="navbarNav">
      <ul class="navbar-nav">
        ...
        <li class="nav-item">
          <a class="nav-link active" href="lab_usage_report.php"><i class="bi bi-calendar-event"></i> Schedule</a>
        </li>
      </ul>
      <ul class="navbar-nav">
        <li class="nav-item">
...
<div class="container mt-5 pt-4">
  ...
  <table class="table table-bordered table-hover">
    ...
    <tbody>
      <?php
      $sql = "
        SELECT l.lab_id, l.lab_name, b.booking_date
        FROM labs l
        JOIN lab_bookings b ON l.lab_id = b.lab_id
      ...
      if ($result && $result->num_rows > 0) {
        ...
        echo "<tr><td colspan='3'>No approved bookings found.</td></tr>";
      }
      ?>
    </tbody>
  </table>
